...
// Tidak lagi menggunakan ledc, jadi konstanta PWM channel, freq, resolution tidak diperlukan
...
void turnLeft(int speed_val) {
  ...
  Serial.print("Motor: Belok Kiri, Kecepatan Kiri: "); Serial.println(speed_val);
}
...
void turnRight(int speed_val) {
  ...
  analogWrite(ENB, speed_val); // Menggunakan analogWrite
  Serial.print("Motor: Belok Kanan, Kecepatan Kanan: "); Serial.println(speed_val);
}
